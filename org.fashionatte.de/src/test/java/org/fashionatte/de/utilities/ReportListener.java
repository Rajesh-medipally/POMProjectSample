...
import org.fashionatte.de.testCases.Base;
...
public class ReportListener extends Base implements ITestListener{
...
//		ITestListener.super.onTestSuccess(result);
	...
	////screenshot path for success
	String screenshotpath= System.getProperty("user.dir")+"\\Screenshots\\success\\"+result.getName()+".png";			
	...
	public void onTestFailure(ITestResult result) {		
		String screenshotpath= System.getProperty("user.dir")+"\\Screenshots\\failure\\"+result.getName()+".png";			
		logger=extent.createTest(result.getName());
